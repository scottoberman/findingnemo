...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_adminMenu_t, stringdata) + ofs \
...
const QMetaObject adminMenu::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_adminMenu.data,
...
void *adminMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_adminMenu.stringdata))
