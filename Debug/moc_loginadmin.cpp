...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_loginAdmin_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_loginAdmin_t qt_meta_stringdata_loginAdmin = {
    {
QT_MOC_LITERAL(0, 0, 10), // "loginAdmin"
QT_MOC_LITERAL(1, 11, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "loginAdmin\0on_pushButton_clicked\0"
};
...
void loginAdmin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        loginAdmin *_t = static_cast<loginAdmin *>(_o);
        switch (_id) {
...
const QMetaObject loginAdmin::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_loginAdmin.data,
      qt_meta_data_loginAdmin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *loginAdmin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_loginAdmin.stringdata))
        return static_cast<void*>(const_cast< loginAdmin*>(this));
